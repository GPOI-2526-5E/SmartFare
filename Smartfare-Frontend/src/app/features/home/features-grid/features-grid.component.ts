  ...
  protected readonly stages: CapabilityStage[] = [
    {
      ...
      cta: 'Apri il planner',
      primaryImage: 'https://res.cloudinary.com/dxudggkln/image/upload/v1780136071/preview_tirsv4.png',
      primaryUrl: 'smartfare.nicolas-dominici.it/itineraries/new',
      secondaryImage: 'https://res.cloudinary.com/dxudggkln/image/upload/v1780136072/preview6_fhogrx.png',
    ...
    },
    {
      ...
      primaryImage: 'https://res.cloudinary.com/dxudggkln/image/upload/v1780136073/preview2_iex7gj.png',
      primaryUrl: 'smartfare.nicolas-dominici.it/profile/itineraries',
      secondaryImage: 'https://res.cloudinary.com/dxudggkln/image/upload/v1780136070/preview4_aefsgx.png',
    ...
    },
    {
      ...
      route: '/voyager',
      cta: 'Parla con l AI',
      primaryImage: 'https://res.cloudinary.com/dxudggkln/image/upload/v1780136067/preview3_synodj.png',
