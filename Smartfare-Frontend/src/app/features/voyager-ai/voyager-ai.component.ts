...
export class VoyagerAiComponent implements OnInit, AfterViewChecked {
  ...
  /** Modale overlay "Creazione in corso" */
  readonly showGeneratingModal = computed(() => this.isGeneratingItinerary());
  /** Modale overlay "Errore generazione" */
  readonly showErrorModal = computed(() => this.generationFailed() && !this.isGeneratingItinerary());
